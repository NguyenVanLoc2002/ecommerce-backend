...
public enum ErrorCode {
    ...
    CARRIER_NOT_FOUND(HttpStatus.NOT_FOUND, "CARRIER_NOT_FOUND", "Carrier not found"),
    CARRIER_CONFIG_MISSING(HttpStatus.NOT_FOUND, "CARRIER_CONFIG_MISSING",
            "Carrier configuration is missing or disabled"),
    CARRIER_CONFIG_DISABLED(HttpStatus.UNPROCESSABLE_ENTITY, "CARRIER_CONFIG_DISABLED",
            "Carrier configuration is disabled"),
    CARRIER_REQUEST_FAILED(HttpStatus.UNPROCESSABLE_ENTITY, "CARRIER_REQUEST_FAILED",
            "Carrier request failed"),
    CARRIER_WEBHOOK_SIGNATURE_INVALID(HttpStatus.BAD_REQUEST, "CARRIER_WEBHOOK_SIGNATURE_INVALID",
            "Carrier webhook signature verification failed"),
    CARRIER_PROVIDER_STATUS_UNKNOWN(HttpStatus.UNPROCESSABLE_ENTITY, "CARRIER_PROVIDER_STATUS_UNKNOWN",
            "Carrier provider returned an unknown status"),
    CARRIER_PROVIDER_NOT_SUPPORTED(HttpStatus.BAD_REQUEST, "CARRIER_PROVIDER_NOT_SUPPORTED",
            "Carrier provider is not supported"),
    ...
    SHIPMENT_PROVIDER_ORDER_NOT_FOUND(HttpStatus.NOT_FOUND, "SHIPMENT_PROVIDER_ORDER_NOT_FOUND",
            "Shipment provider order was not found"),
